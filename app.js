...
app.use('/media/files', cors(), express.static(path.join(__dirname, 'uploads/media/files')));
app.use('/media/thumbnails', cors(), express.static(path.join(__dirname, 'uploads/media/thumbnails')));
